...
sgMail.setApiKey("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");
...
app.post("/cursos",upload.single("avatar"),(req,res) =>{
    ...
    Usuario.findOne({cedula : req.body.id}).exec((err,resultado) =>{
        ...
        if (resultado != null){
            ...
            let msg = {
                to: req.body.correo,
                from: "matmartinezpal@unal.edu.co",
                subject: "Bienvenido!",
                html: `Bienvenido a nuestro proyecto, ${req.body.nombre}.<br>Por seguridad guarde los datos de inicio de sesion con los que se registro.<br><br>
                Usuario: <b>${req.body.id}</b><br>
                Contraseña: <b>${req.body.password}</b>`
            }
